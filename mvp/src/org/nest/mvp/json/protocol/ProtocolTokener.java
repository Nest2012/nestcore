//Source file: C:\\svn-pingtai\\longtuRPC\\code\\src\\com\\longtu\\framework\\rpc\\protocol\\ProtocolTokener.java
...
/**
 * A ProtocolTokener takes a source string and extracts characters and tokens from
 * it. It is used by the ProtocolObject and ProtocolArray constructors to parse Protocol
 * source strings.
 * <p>
...
public class ProtocolTokener {
    ...
    /**
     * Construct a ProtocolTokener from a string.
     * 
     * @param s
     *            A source string.
     */
    public ProtocolTokener(String s) {
        myIndex = 0;
        mySource = s;
    }
     ...
     * processing is done. The formal Protocol format does not allow strings in
     ...
     * ProtocolArray, ProtocolObject, or String, or the ProtocolObject.NULL object.
     * 
     * @exception ParseException
     *                The source conform to Protocol syntax.
     * 
     * @return An object.
     */
    public Object nextValue() throws ParseException {
        ...
        if (c == '{') {
            back();
            return new ProtocolObject(this);
        }
        if (c == '[') {
            back();
            return new ProtocolArray(this);
        }
        StringBuffer sb = new StringBuffer();
        char b = c;
        while (c >= ' ' && c != ':' && c != ',' && c != ']' && c != '}' && c != '/') {
    ...
    /**
     * Make a printable string of this ProtocolTokener.
     * 
